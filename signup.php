...
<p><table style="width:100%;"><tr><td><input class="form-control" placeholder="Subdomain" type=text name=username value="" pattern="[a-z0-9]{4,15}" maxlength="16" required></td><td><span class="btn btn-default disabled">.<? echo "$yourdomain" ;?></span></td></tr></table></p>
...
<input class="form-control" placeholder="Captcha" type=text pattern=".{4,6}" name=number required></td>
</tr></table></p>
