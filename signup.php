...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <table style="width:100%;"><tr><td><p align="left"><a class="navbar-brand" href="/index.php"><img style="width:100%; max-width: 300px;" src="logo.png"></a></p></td><td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="modal-footer">
                    Price <font color="red">0.00</font><b>$</b> Monthly
                </div>
            </div>
        </div>
    </div>
